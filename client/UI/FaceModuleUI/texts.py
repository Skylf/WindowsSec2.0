...
TEXTS = {
    LANG_ZH: {
        ...
        "user.click_to_login": "点击登录",
        "user.nickname": "昵称",
        "user.username": "用户名",
        "user.email": "邮箱",
        "user.role": "角色",
        "user.btn_logout": "退出登录",
        "user.btn_login": "登录 / 注册",
        "user.logout_confirm": "确定要退出登录吗?",

        # ═══════════ 登录页 ═══════════
        "login.title": "账号登录",
        "login.subtitle": "Windows 安全系统 2.0",
        "login.identity": "用户名 / 邮箱",
        "login.identity_placeholder": "请输入用户名或邮箱",
        "login.password": "密码",
        "login.password_placeholder": "请输入密码",
        "login.email_code": "邮箱验证码",
        "login.code_placeholder": "请输入验证码",
        "login.send_code": "发送验证码",
        "login.btn_login": "登 录",
        "login.no_account": "没有账号?",
        "login.to_enroll": "去注册",
        "login.error_empty_identity": "请输入用户名或邮箱",
        "login.error_empty_password": "请输入密码",
        "login.btn_cancel": "取 消",
        "login.auto_login": "自动登录（一周内免密登录）",
        "login.need_login_title": "提示",
        "login.need_login": "您还未登录，请登录后再使用",

        # ═══════════ 注册页 ═══════════
        "enroll.title": "账号注册",
        "enroll.subtitle": "创建您的 Windows 安全系统账号",
        "enroll.nickname": "昵称",
        "enroll.nickname_placeholder": "1-10 字符, 支持中英文/数字",
        "enroll.username": "用户名",
        "enroll.username_placeholder": "1-10 字符, 支持中英文/数字",
        "enroll.password": "密码",
        "enroll.password_placeholder": "6-18 字符, 不含中文",
        "enroll.confirm_password": "确认密码",
        "enroll.confirm_placeholder": "请再次输入密码",
        "enroll.email": "邮箱",
        "enroll.email_placeholder": "请输入邮箱地址",
        "enroll.email_code": "邮箱验证码",
        "enroll.code_placeholder": "请输入验证码",
        "enroll.send_code": "发送验证码",
        "enroll.btn_enroll": "注 册",
        "enroll.has_account": "已有账号?",
        "enroll.to_login": "去登录",
        "enroll.error_empty_nickname": "请输入昵称",
        "enroll.error_empty_username": "请输入用户名",
        "enroll.error_empty_password": "请输入密码",
        "enroll.error_password_mismatch": "两次密码输入不一致",
        "enroll.error_empty_email": "请输入邮箱",
        "enroll.error_empty_code": "请输入验证码",
        "enroll.btn_cancel": "取 消",
        "enroll.btn_prev": "上一步",
        "enroll.btn_next": "下一步",
    ...
    LANG_EN: {
        ...
        "user.click_to_login": "Click to login",
        "user.nickname": "Nickname",
        "user.username": "Username",
        "user.email": "Email",
        "user.btn_logout": "Logout",
        "user.btn_login": "Login / Register",
        "user.logout_confirm": "Are you sure you want to logout?",

        # ═══════════ Login page ═══════════
        "login.title": "Account Login",
        "login.subtitle": "Windows Security System 2.0",
        "login.identity": "Username / Email",
        "login.identity_placeholder": "Enter username or email",
        "login.password": "Password",
        "login.password_placeholder": "Enter password",
        "login.email_code": "Email Code",
        "login.code_placeholder": "Enter verification code",
        "login.send_code": "Send Code",
        "login.btn_login": "Login",
        "login.no_account": "No account?",
        "login.to_enroll": "Register",
        "login.error_empty_identity": "Please enter username or email",
        "login.error_empty_password": "Please enter password",
        "login.btn_cancel": "Cancel",
        "login.auto_login": "Auto login (password-free within 7 days)",
        "login.need_login_title": "Notice",
        "login.need_login": "Please log in first to use this feature.",

        # ═══════════ Register page ═══════════
        "enroll.title": "Register",
        "enroll.subtitle": "Create your Windows Security System account",
        "enroll.nickname": "Nickname",
        "enroll.nickname_placeholder": "1-10 chars, letters/numbers/Chinese",
        "enroll.username": "Username",
        "enroll.username_placeholder": "1-10 chars, letters/numbers/Chinese",
        "enroll.password": "Password",
        "enroll.password_placeholder": "6-18 chars, no Chinese",
        "enroll.confirm_password": "Confirm Password",
        "enroll.confirm_placeholder": "Re-enter password",
        "enroll.email": "Email",
        "enroll.email_placeholder": "Enter email address",
        "enroll.email_code": "Email Code",
        "enroll.code_placeholder": "Enter verification code",
        "enroll.send_code": "Send Code",
        "enroll.btn_enroll": "Register",
        "enroll.has_account": "Already have an account?",
        "enroll.to_login": "Login",
        "enroll.error_empty_nickname": "Please enter nickname",
        "enroll.error_empty_username": "Please enter username",
        "enroll.error_empty_password": "Please enter password",
        "enroll.error_password_mismatch": "Passwords do not match",
        "enroll.error_empty_email": "Please enter email",
        "enroll.error_empty_code": "Please enter verification code",
        "enroll.btn_cancel": "Cancel",
        "enroll.btn_prev": "Previous",
        "enroll.btn_next": "Next",
