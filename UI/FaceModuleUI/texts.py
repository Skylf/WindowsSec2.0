...
TEXTS = {
    LANG_ZH: {
        ...
        "watermark.bbox.placeholder": "留空=自动检测; 格式 x1,y1,x2,y2(像素), 如 900,200,1000,300",
    ...
    LANG_EN: {
        ...
        "watermark.bbox.placeholder": "Empty = auto-detect; format x1,y1,x2,y2 (px), e.g. 900,200,1000,300",
