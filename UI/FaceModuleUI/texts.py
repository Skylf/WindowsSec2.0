...
TEXTS = {
    LANG_ZH: {
        ...
        "watermark.output.placeholder": "选择输出文件夹(留空=输入同目录, 文件名自动生成)",
        ...
        "watermark.bbox.placeholder": "留空=自动检测; 格式 x1,y1,x2,y2(像素), 多个用分号分隔",
        ...
        "watermark.log.empty": "选择视频后点击\"开始处理\"; 处理过程将实时显示在这里(检测/细化/加载/进度)",
    ...
    LANG_EN: {
        ...
        "watermark.output.placeholder": "Select an output folder (empty = same dir, auto-named)",
        ...
        "watermark.bbox.placeholder": "Empty = auto-detect; format x1,y1,x2,y2 (px), multiple separated by ';'",
        ...
        "watermark.log.empty": "Select a video and click Start; the process will show here in real time (detect/refine/load/progress)",
