...
TEXTS = {
    LANG_ZH: {
        ...
        "watermark.log.start": "开始处理: {0} | 引擎 {1} | GPU {2} | 定位 {3} | 模式 {4}",
        "watermark.log.output": "输出: {0}",
        "watermark.log.done": "处理完成, 总耗时 {1} → {0}",
    ...
    LANG_EN: {
        ...
        "watermark.log.start": "Start: {0} | Engine {1} | GPU {2} | Locate {3} | Mode {4}",
        "watermark.log.output": "Output: {0}",
        "watermark.log.done": "Done in {1} -> {0}",
